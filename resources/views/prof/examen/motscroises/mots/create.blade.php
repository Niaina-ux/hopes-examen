...
<div class="w-full py-3">
    ...
    <div class="bg-white p-4 rounded-md">
        <h2 class="text-xl font-semibold mb-4">Créer un exercice mots croisés</h2>
        ...
        <form id="mc-form" action="{{ route('prof.examen.motscroises.store', [$slug, $examen->id]) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="titre" value="{{ old('titre') }}" class="border rounded w-full p-2" placeholder="Ex: Mots croisés - Vocabulaire">
            </div>
            ...
            <div class="flex gap-4 mb-4">
                ...
                <div class="flex-1">
                    ...
                    <input type="number" name="note_totale" value="{{ old('note_totale', 20) }}" min="0.1" step="0.1" class="border rounded w-full p-2">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex gap-3 items-end">
                    <div>
                        ...
                        <input type="number" id="grille-largeur" value="10" min="2" max="20" class="border rounded p-2 w-24">
                    </div>
                    <div>
                        <label class="block text-xs text-black/50">Hauteur (lignes)</label>
                        <input type="number" id="grille-hauteur" value="10" min="2" max="20" class="border rounded p-2 w-24">
                    </div>
