    ...
    <div class="py-3 me-2">
        ...
        <div class="">
            @forelse($redactions as $index => $redaction)
                <div class="flex gap-5 justify-betwee my-2 p-2 border border-black/10 rounded-md">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between gap-3 items-start  pb-1">
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold"> {{$redaction->titre}} </h3>
                                <div class="text-sm flex gap-3 ">
                                    <span class=" text-vert"> {{$redaction->nombre_mots_max}} Mots max  </span>
                                    <span class="text-rouge "> {{$redaction->note_totale}} Pts  </span>
                                </div>
                            </div>
                        ...
                        <div class="mt-2 p-2 px-3 bg-black/2 border border-black/3 rounded-md ">
