...
<div class="bg-white p-4 rounded-md">
    ...
    <form action="{{ route('prof.examen.pointiller.update', [$slug, $examen->id, $pointiller->id]) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="flex gap-4 mb-4">
            <div class="flex-1">
                ...
                <input type="number" name="duree_minutes" value="{{ old('duree_minutes', $pointiller->duree_minutes) }}" class="border rounded w-full p-2">
            ...
            <div class="flex-1">
                ...
                <input type="number" name="note_totale" value="{{ old('note_totale', $pointiller->note_totale) }}" class="border rounded w-full p-2">
