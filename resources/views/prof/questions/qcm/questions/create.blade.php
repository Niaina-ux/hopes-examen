...
<div class="py-3">
    <div class="w-full ">
        <div class=" rounded-md ">
            <h2 class="text-2xl border-b-2 border-black/20 pb-1 font-semibold mt-2 mb-4 text-vert
                dark:border-white/20">Ajouter une question — {{ $qcm->titre }}</h2>
            @if(session('success'))
            ...
            <form action="{{ route('prof.qcm.question.store', [$slug, $qcm->id]) }}" method="POST" enctype="multipart/form-data" 
                ...
                <div class="question-block rounded-md mb-4">
                    <div class="mb-2">
                        ...
                        <textarea name="questions[0][enonce]" rows="2" 
                            class="formulaire border bg-white border-black/20 rounded w-full p-2
                            dark:bg-white/2 dark:border-white/20" 
                            required placeholder="Combien de ...example de question ">{{ old('questions.0.enonce') }}</textarea>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="flex gap-4 mb-2">
                            <label class="flex items-center gap-2 border rounded-md p-2 px-4 bg-black/3 border-black/20
                                dark:border-white/20 dark:bg-white/2">
                        ...
                        <div class="media-video-block hidden my-4">
                            <label for="" class="">Choisir le fichier</label>
                            <input type="file" name="questions[0][video]" accept="video/*" 
                                class="bg-white formulaire border border-black/20 rounded w-full p-2
                                dark:bg-white/2 dark:border-white/20">
                    ...
                    <div class="w-[15cm] my-2 mt-3">
                        <div class="flex gap-5 ">
                            <div class=" w-[3cm]">
                                ...
                                <input type="text" name="questions[0][points]" value="{{ old('questions.0.points') }}" min="0.1" step="0.1" 
                                    class="border bg-white formulaire border-black/20 rounded w-full p-2
                                    dark:bg-white/2 dark:border-white/20" 
                                    placeholder="1">
                            ...
                            <div class=" w-[3cm]">
                                ...
                                <input type="text" name="questions[0][duree_seconde]" value="{{ old('questions.0.duree_seconde') }}" min="0.5" step="0.1" 
                                    class="bg-white formulaire border border-black/20 rounded w-full p-2
                                    dark:bg-white/2 dark:border-white/20" 
                                    placeholder="10">
                            ...
                            <div class=" flex-1">
                                ...
                                <select name="questions[0][reponse_type]" 
                                    class="bg-white formulaire reponse-type border border-black/20 rounded w-full p-2
                                    dark:bg-white/2 dark:border-white/20" onchange="toggleReponseType(this, 0)">
                        ...
                        <div class="choices-container space-y-2">
                            <div>
                                ...
                                dark:border-white/20 ">
                                    ...
                                    <input type="text" name="questions[0][choices][0][texte]" placeholder="Choix 1" 
                                        class="p-2 flex-1 border-s-2 bg-white outline-0 border-black/20
                                        dark:bg-white/2 dark:border-white/20" 
                                        value="{{ old('questions.0.choices.0.texte') }}">
                                </div>
                            ...
                            <div>
                                <div class="flex gap-2 formulaire items-center border border-black/20 rounded ps-2
                                    ...
                                    <input type="text" name="questions[0][choices][1][texte]" placeholder="Choix 2" 
                                        class="border-s-2 bg-white border-black/20 outline-0 p-2 flex-1
                                        dark:bg-white/2 dark:border-white/20" 
                                        value="{{ old('questions.0.choices.1.texte') }}">
                                </div>
