...
<div id="{{ $id }}" class="fixed inset-0 bg-black/20 hidden items-center justify-center z-160 backdrop-blur-xs">
    <div class="bg-white rounded-md p-8 w-[12cm] text-center">
        ...
        <div class="flex justify-center gap-3">
            <button type="button" onclick="closeModal('{{ $id }}')" class="border text-black/60 border-black/10 rounded-md px-5 py-2">
                {{ $cancelText }}
            </button>
