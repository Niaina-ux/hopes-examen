...
class ProfStudentController extends Controller
{
    ...
    // private function calculerPourcentageAttempt(Examen $examen, ExamAttempt $attempt): ?float
    // {
    //     if ($attempt->status !== 'corrige') {
    //         return null; // Mbola tsy voatsara daholo — tsy azo kajiana
    //     }
    ...
    //                 $totalObtenus += \App\Models\PointillerEtudiantReponse::whereIn(
    ...
    //                 $totalObtenus += \App\Models\RelierReponse::whereIn(
    //                     'relier_paire_id',
